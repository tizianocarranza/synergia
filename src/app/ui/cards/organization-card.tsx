...
import { userOrganizationWithColors } from "@/app/lib/definitions";


export default function OrganizationCard({ organization }: { organization: userOrganizationWithColors }) {
