...
export default function Account() {
    ...
    return (
        ...
        >
                ...
                <p>Whether you’re a developer looking to expand your career or you represent an organization seeking the best candidates, Synergia provides the platform to <span className="text-brand">synergize</span> and succeed.</p> 
        </MainPage>
